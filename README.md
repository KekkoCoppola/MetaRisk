...
## 📊 Data Acquisition
Please follow the instructions in [data/README.md](data/README.md) to download the dataset from Zenodo and place it into [data/raw/](data/raw/)

---

## 📖 Citation & Acknowledgements
See [CITATION.cff](CITATION.cff) and the Data Attrobution section in [data/README.md](data/README.md)
...
### 1. Environment Setup
```bash
git clone [https://github.com/TuoUsername/nome-repo.git](https://github.com/TuoUsername/nome-repo.git)
cd nome-repo
python -m venv .venv
